<template>
  <div class="content-box">
      ...
      <el-table ref="Table1"
          ...
          <el-table-column label="相似度" align="center" :show-overflow-tooltip="true">
          ...
          <el-table-column label="口罩" align="center" :show-overflow-tooltip="true">
          <template slot-scope="scope">{{scope.row.mask}}</template>
          </el-table-column>
          <el-table-column label="眼镜" align="center">
          <template slot-scope="scope">{{scope.row.glass}}</template>
          </el-table-column>
          <el-table-column label="表情" align="center">
          <template slot-scope="scope">{{scope.row.expression}}</template>
          </el-table-column>
          <el-table-column label="胡子" align="supervisionUnit">
          <template slot-scope="scope">{{scope.row.mustache}}</template>
          </el-table-column>
          <el-table-column label="帽子" align="supervisionUnit">
          <template slot-scope="scope">{{scope.row.cap}}</template>
          </el-table-column>
  ...
  export default {
      ...
      methods:{
          getData(){
              ...
              axios.get('http://localhost:8077/getAlarm',
              {
                  params:{
                      "msg_id": "1036",
                      "sessionId":sessionId
